...
<!-- Login Button -->
<button id="toggle-form-btn" class="btn btn-outline-secondary login-btn" onclick="submitForm()"><i class="fas fa-sign-in-alt"></i>Login Instead?</button>
...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <div class="custom-form" id="register-form" ">
...
<script>
    function submitForm() {
       window.location.href = "/lab2/LoginRegister.jsp";
    }
