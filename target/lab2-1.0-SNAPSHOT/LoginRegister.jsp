...
<!-- Login Button -->
<button id="toggle-form-btn" class="btn btn-outline-secondary login-btn" onclick="toggleForm()"><i class="fas fa-sign-in-alt"></i> Register</button>

<!-- Header -->
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="custom-form" id="login-form">
                <h1 class="display-4 text-center mb-4">Welcome to StreamFlix</h1>
                <p class="lead text-center mb-4">Please login to your account below.</p>

                <!-- Description -->
                <form action="/lab2/Login" method="POST" class="needs-validation" novalidate>
            ...
            <div class="custom-form" id="register-form" style="display: none;">
