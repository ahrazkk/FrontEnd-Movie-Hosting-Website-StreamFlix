              ...
              <div class="col-8 col-lg-4 col-xl-3">
                <div class="card border-0">
                  <div class="card-body text-center py-4">
                    ...
                    <a href="/lab2/Subscription_I.jsp" class="btn btn-outline-primary btn-lg mt-3">
                      Buy Now
                    </a>
                  </div>
                </div>
              ...
              <div class="col-9 col-lg-4">
                <div class="card border-primary border-2">
                  ...
                  <div class="card-body text-center py-5">
                    ...
                    <a href="/lab2/Subscription_II.jsp"class="btn btn-outline-primary btn-lg mt-3" oneclick ="logOut()">
                      Buy Now
                    </a>
                  </div>
                </div>
              ...
              <div class="col-8 col-lg-4 col-xl-3">
                <div class="card border-0">
                  <div class="card-body text-center py-4">
                    ...
                    <a href="/lab2/Subscription_III.jsp" class="btn btn-outline-primary btn-lg mt-3">
                      Buy Now
                    </a>
                  </div>
                </div>
